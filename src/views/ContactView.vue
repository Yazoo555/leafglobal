        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2">
            <div class="card-base p-8 sm:p-10">
              <h2 class="text-2xl font-heading font-bold text-dark mb-2">Send Us a Message</h2>
              <p class="text-sm text-text-light mb-8">Fill out the form and we'll get back to you within 24 hours.</p>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      required
                      class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-text placeholder:text-text-light/50 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary transition-all duration-200"
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                    class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-text focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary transition-all duration-200"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="5"
                    class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-text placeholder:text-text-light/50 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary transition-all duration-200 resize-none"
                ...
                <div class="flex items-center justify-between">
                  <p class="text-xs text-text-light">We respect your privacy and will never share your information.</p>
                  <Button
                    type="submit"
                    variant="primary"
                    size="lg"
          ...
          <div class="flex flex-col h-full gap-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div v-for="item in contactMethods" :key="item.title" class="card-base p-5 flex flex-col items-start">
            ...
            <!-- Social -->
            <div class="card-base p-5 mt-auto">
              <h4 class="font-heading font-semibold text-dark text-sm mb-3">Follow Us</h4>
              <div class="flex gap-2.5">
                <a
                  ...
                  class="w-9 h-9 rounded-lg bg-primary-50 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all duration-200"
            ...
            >
              <div v-if="openFaqs.includes(index)" class="px-8 pb-8 pt-4">
                <div class="border-l-2 border-primary/20 pl-4">
                  <p class="text-sm text-text-light leading-relaxed">{{ faq.answer }}</p>
                </div>
              </div>
            </transition>
          </div>
    ...
    <section class="section-padding bg-background">
      <div class="container-custom">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div class="mt-8 space-y-4">
              <div v-for="office in offices" :key="office.city" class="flex gap-4">
                ...
                <div>
                  <h4 class="font-heading font-semibold text-dark text-sm">{{ office.city }}</h4>
                  <p class="text-sm text-text-light">{{ office.address }}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Google Map -->
          <div class="aspect-[4/3] rounded-2xl overflow-hidden relative shadow-lg">
            <iframe
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="absolute bottom-4 right-4 inline-flex items-center gap-2 px-4 py-2.5 bg-white text-dark text-sm font-medium rounded-lg shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all duration-200 z-10"
            >
